 ...
 */
public class PlayMybatisModule extends PrivateModule{
    ...
    protected void configure() {
         ...
         */
        bind(SqlSession.class).annotatedWith(Names.named("dev")).toProvider(SqlSessionManagerProvider.class).in(Scopes.SINGLETON);
        expose(SqlSession.class).annotatedWith(Names.named("dev"));
